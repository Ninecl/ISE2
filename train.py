...
def main(params):
    ...
    adj_list, triplets2id_data, entity2id, relation2id = generate_subgraph_datasets(params, 0)
    ...
    elif params.model_type == "CoMPILE":
        from model.framework import CoMPILE as dgl_model
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_type', '-mt', type=str, choices=['Grail', 'ISE2', 'CoMPILE'], default='ISE2',
    ...
    parser.add_argument("--out_method", type=str, default='sum', choices=['sum', 'mean'],
                        help="output method in the graphpooling")
    ...
    # create experiment
    params.experiment_name = '_'.join((params.experiment_name, f'hop{params.hop}'))
    ...
    params.file_paths = {
        0: {'support': os.path.join(params.main_dir, f'data/{params.dataset}/ori/{params.train_file}.txt'),
            'query': os.path.join(params.main_dir, f'data/{params.dataset}/ori/{params.valid_file}.txt')}
    }
