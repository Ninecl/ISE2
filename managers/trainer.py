...
from utils.dgl_utils import move_batch_to_device_dgl, collate_dgl, collate_dgl_CoMPILE
...
class Trainer():
    ...
    def train_epoch(self):
        ...
        dataloader = DataLoader(self.train_data, batch_size=self.params.batch_size, shuffle=True, num_workers=self.params.num_workers, collate_fn=self.collate_dgl)
        self.model.train()
        model_params = list(self.model.parameters())
